...
Else you can use [online command prompt](/docs/wiki-md/EN/Online CometQL command line.md). You can find it on the bottom of the right corner on all of the pages.  


___
[Here you can test source code based on PHP with CometQL](/docs/wiki-md/EN/Online CometQL command line.md) using for online command prompt implementation.
___
...
Notes of current implementation of CometSQL:
  ...
  * To [optimize internal logics](/docs/wiki-md/EN/API/Optimization delete, and insert in CometQL.md), such operations like delete and insert doesn’t return amount of used lines (it belongs to CometQL v.1.0).
  * Supporting such operators like AND, OR and ORDER BY in queries will be realize soon.


___
Some of hosting providers determine forbiddance (или ban) on external connections – you can face with this on some free or half-free hosting services. In order to check ability to use CometQL, you can take advantage of [hosting verification script](/docs/wiki-md/EN/Checking the hosting for possible connect to the comet server.md). 
___
...
The table “users_in_pipes” contains data about [authorized users](/docs/wiki-md/EN/API/Users’ authorization on the comet-server.md) which subscribe on channel. This table is available only for reading.  
...
___
Field user in table pipes contain aggregate amount of subscribers ([authorized and non-authorized](/docs/wiki-md/EN/API/Users’ authorization on the comet-server.md)), besides of table users_in_pipes includes only authorized subscribers list.
___
...
The table “users_messages” intended sending messages to [authorized users](/docs/wiki-md/EN/API/Users’ authorization on the comet-server.md) by their identifiers.
...
The table users_auth contains data of user’s [authorizing](/docs/wiki-md/EN/API/Users’ authorization on the comet-server.md) on comet server. 
...
To deleting data of [user’s authorizing](/docs/wiki-md/RU/API/Авторизация пользователей.md), you can use “delete” query.
...
# Other information
  ...
  * [Example of sending messages from bash.](/docs/wiki-md/EN/An example of sending a message from a bash script.md)
  * [Error code in CometQL](/docs/wiki-md/EN/API/Error codes in CometQL.md)
  * [Reserved channel names](/docs/wiki-md/EN/API/Reserved channel names.md)
  * [JavaScript API](/docs/wiki-md/EN/API/JavaScript API/JavaScript API.md)
  * [What it is and why do we need "A public developer token" and "Secret developer key?"](/docs/wiki-md/EN/What is “the public developer’s ID” and “the secret developer’s key”?.md)

# Reserved channels names

Main article [Reserved channels names and channels with extra properties](/docs/wiki-md/EN/API/Reserved channel names.md).
