...
We recommend you to read these articles:
  ...
  * [PHP chat example](Examples/PHP%20chat%20example.md)  
  ...
  * [An example of sending a message from a bash script](Examples/An%20example%20of%20sending%20a%20message%20from%20a%20bash%20script.md)