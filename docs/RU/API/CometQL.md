...
Или ещё можете использовать [онлайн командную строку](/docs/wiki-md//Онлайн CometQL командная строка.md). Она расположена в правом нижнем углу экрана на всех старицах.


___
Есть [пример исходных кодов на PHP с использованием CometQL](/docs/wiki-md//Онлайн CometQL командная строка.md) для реализации онлайн командной строки
___
...
Замечания по реализации текущей версии CometQL:
  ...
  * В целях [оптимизации внутренней логики](/docs/wiki-md/RU/API/Оптимизации delete и insert в CometQL.md) операции delete и insert не возвращают количество затронутых строк, по крайней мере так будет в CometQL версии 1.0
  * Поддержка в запросах операторов OR, AND и ORDER BY будет реализована позже.


___
У некоторых хостинг провайдеров установлен запрет на внешние соединения, это достаточно часто встречается на бесплатных или очень очень дешёвых хостингах. Для того что бы проверить возможность использования CometQL воспользуйтесь [скриптом проверки хостинга](/docs/wiki-md/RU/Решение проблем/Проверка хостинга на предмет возможности подключится к комет серверу.md). 
___
...
Таблица users_messages предназначена для отправки сообщений [авторизованным пользователям](/docs/wiki-md/RU/API/Авторизация пользователей.md) по их идентификатору.
...
Таблица <abbr>Таблица содержит данные для авторизации пользователей на комет сервере(users_auth)</abbr>  содержит данные для [авторизации пользователей](/docs/wiki-md/RU/API/Авторизация пользователей.md) на комет сервере.
...
Для удаления данных [авторизации пользователей](/docs/wiki-md/RU/API/Авторизация пользователей.md) используйте запрос delete
...
___
В целях [оптимизации внутренней логики операции](/docs/wiki-md/RU/API/Оптимизации delete и insert в CometQL.md) delete и insert не возвращают количество затронутых строк, по крайней мере так будет в QometQL версии 1.0
___


# Дополнительная информация

  * [Пример использования CometQL на php](/docs/wiki-md//Онлайн CometQL командная строка.md)
  * [Пример отправки сообщения из bash](/docs/wiki-md/RU/Примеры/Пример отправки сообщения из bash скрипта.md)
  * [Коды ошибок CometQL](/docs/wiki-md/RU/API/Коды ошибок в CometQL.md)
  * [Зарезервированные имена каналов](/docs/wiki-md/RU/API/Зарезервированные имена каналов.md)
  * [JavaScript API](/docs/wiki-md/RU/API/JavaScript API.md)
...
Основная статья [зарезервированные имена каналов](/docs/wiki-md/RU/API/Зарезервированные имена каналов.md)
