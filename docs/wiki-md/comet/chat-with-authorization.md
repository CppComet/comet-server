...
[Online demo](https///comet-server.com/doc/example/4).md
...
Здесь рабочее [online демо чата с авторизацией](https///comet-server.ru/doc/example/5/).md. 
...
Второй параметр это ваш [публичный идентификатор разработчика](comet/dev_id).md.
Третий параметр это ваш [секретный ключ разработчика](comet/dev_id).md.
